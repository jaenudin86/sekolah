            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <?php else : ?>
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">siswa yang di pegang</div>
                        <?php endif ?>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <?php else : ?>
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> Kelas yang di pegang</div>
                        <?php endif ?>
                        <?php if ($kelas !== null) { ?>
...
<?php endif ?>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-success">Total siswa : <?= number_format($tot_siswa, 0, ',', '.') ?></h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success">Profile Website</h6>
                </div>
                <div class="card-body">
    ...
    <div class="row">
    <?php if ($user['role_id'] !== '4' && $user['role_id'] !== '6') : ?>

        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-list fa-fw"></i> 7 siswa Dengan Point Terendah</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-list fa-fw"></i> 7 Jenis Pelanggaran Yang Sering Terjadi</h6>
                </div>
                <div class="card-body">
