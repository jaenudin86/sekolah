...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-cogs fa-fw"></i> Pengaturan Akun</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/setting') ?>" method="post">
                        ...
                        <button type="submit" name="kirim" class="btn btn-success btn-rd5">Submit</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-cogs fa-fw"></i> Ganti Password</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/edit_pass') ?>" method="post">
                        ...
                        <button type="reset" class="btn btn-danger btn-rd5" onclick="document.getElementById('InputID').value = ''">Ulangi</button>
                        <button type="submit" name="kirim" class="btn btn-success btn-rd5">Ganti Password</button>
