                                                ...
                                                <form action="<?= base_url('update/update_kelas') ?>" method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="wali" name="wali" value="<?= $d['wali'] ?>" placeholder="Wali Kelas">
                                                            <input type="hidden" name="wali1" id="wali1" value="<?= $d['wali'] ?>">
                                                        </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kelas') ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="wali">Wali Kelas</label>
                        <input type="text" class="form-control" id="wali" name="wali" placeholder="Wali Kelas">
                    </div>
                    <div class="form-group">
                        <label for="pendidikan">Pendidikan</label>
