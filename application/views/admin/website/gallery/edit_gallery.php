...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="float-right mr-1">
            <a href="<?= base_url('admin/gallery') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa fa-arrow-left"></i> Data Gallery</a>
        </div>
    </div>
            ...
            <div class="card-header">
                <h6 class="card-title"><i class="fas fa-newspaper"></i> Tambah Gallery
                    <div class="float-right">
                        <a target="_blank" href="<?= base_url('detail_gallery?id=' . $a['id']) ?>" class="btn btn-block btn-sm btn-success"><i class="fa fas fa-external-link-alt"></i> Detail Gallery</a>
                    </div>
                </h6>
            </div>
