...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-cogs fa-fw"></i> Update Email Sender</h6>
                </div>
                <div class="card-body">
                    ...
                    <?php foreach ($email_sender as $d) : ?>
                        ...
                        <form action="<?= base_url('admin/email_sender') ?>" method="post">
                            ...
                            <div class="pt-3 form-group row">
                                <label></label>
                                <button onclick="return confirm('Lanjutkan Simpan Data?');" type="submit" class="btn btn-block btn-success">Simpan</button>
                            </div>
                        </form>
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-cogs fa-fw"></i> Test Email Sender</h6>
                </div>
                <div class="card-body">
                    <?= form_error('menu', '<div class="alert alert-danger" role="alert">', '</div>') ?>
                    ...
                    <form action="<?= base_url('admin/test_email_sender') ?>" method="post">
                        ...
                        <div class="pt-3 form-group">
                            <label></label>
                            <button type="submit" class="btn btn-block btn-success"><i class="fas fa-paper-plane"></i> Kirim</button>
                        </div>
                    </form>
                </div>
