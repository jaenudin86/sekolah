...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6" id="accordion">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-cogs fa-fw"></i> Edit website</h6>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div id="headingOne">
                        ...
                        <?php foreach ($website as $d) : ?>
                            <form action="<?= base_url('admin/website') ?>" method="post">
                                ...
                                <div class="pt-3 form-group row">
                                    ...
                                    <button type="submit" class="btn-block btn btn-success">Simpan</button>
                                </div>
                            </form>
                    </div>
                </div>
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-cogs fa-fw"></i> Edit G-maps</h6>
                </div>
                <div class="card-body">
                    <?= form_error('menu', '<div class="alert alert-danger" role="alert">', '</div>') ?>
        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-cogs fa-fw"></i> Gambar website</h6>
                </div>
                <div class="card-body">
                    <?= form_error('menu', '<div class="alert alert-danger" role="alert">', '</div>') ?>
