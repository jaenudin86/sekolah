        ...
        <div class="col-lg-7 offset-lg-2">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-cogs fa-fw"></i> Update Payment Gateway</h6>
                </div>
                <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <button data-toggle="tooltip" title="Salin Link" class="btn btn-success btn-sm" id="clipboard" data-ref="<?= base_url('callback') ?>"><i class="fa fa-copy"></i></button>
                                    </div>
                                </div>
                            </div>
