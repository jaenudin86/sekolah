...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="float-right mr-1">
            <a href="<?= base_url('admin/acara') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa fa-arrow-left"></i> Data Acara</a>
        </div>
    </div>
        ...
        <div class="card card-success">
            <div class="card-header">
                <h6 class="card-title"><i class="fas fa-newspaper"></i> Edit Acara
                    <div class="float-right">
                        <a target="_blank" href="<?= base_url('detail_acara?id=' . $a['id']) ?>" class="btn btn-block btn-sm btn-success"><i class="fa fas fa-external-link-alt"></i> Detail Acara</a>
                    </div>
                </h6>
            </div>
            ...
            <form method="post" action="<?= base_url('admin/edit_acara') ?>" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group">
                                <label>Kategori Acara <a href="#" class="badge badge-success" data-toggle="modal" data-target="#addKat"> Tambah</a></label>
                ...
                <div class="card-footer">
                    <button class="btn btn-success" onclick="return confirm('Lanjutkan Simpan Acara?');"><i class="fa fa-check"></i> Simpan Acara</button>
