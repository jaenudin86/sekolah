						...
						<div class="col-md-12">
							<div class="box box-success">
								...
								<div class="box-body">
									...
									<hr />
									<div class="col-sm-10 text-center pt-10">
										...
										<a class="btn btn-warning btn-sm" href="<?= site_url('manage/jenis_pembayaran/add_payment_bebas_majors/' . $payment['payment_id']) ?>"><span class="fa fa-plus"></span> Berdasarkan Jurusan</a>
										<a class="btn btn-success btn-sm" href="<?= site_url('manage/jenis_pembayaran/add_payment_bebas/' . $payment['payment_id']) ?>"><span class="fa fa-plus"></span> Berdasarkan Kelas</a>
