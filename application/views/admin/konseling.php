            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Anda yakin ingin menutup data <b><?= $d['nama_siswa'] ?></b> dengan konseling <b><?= $d['topik'] ?></b></p>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="<?= base_url('update/tutup_konseling/admin') ?>" method="post">
                            ...
                            <input type="hidden" name="siswa" value="<?= $d['nama_siswa'] ?>">
        ...
        <div class="modal fade" id="deleteData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Anda yakin ingin menghapus data <b><?= $d['nama_siswa'] ?></b> dengan konseling <b><?= $d['topik'] ?></b></p>
                    </div>
