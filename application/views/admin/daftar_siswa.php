                ...
                <div class="card-body">
                    <h4 class="mb-5 header-title"><i class="fas fa-list"></i> <?= $title ?>
                        <div class="float-right mr-1">
                            <a href="" class="btn btn-block btn-info btn-sm" data-toggle="modal" data-target="#exportData"><i class="fa fa-file-export"></i> Export</a>
                        </div>
                    ...
                    <form style="margin: 20px 0;" action="<?= base_url() . 'admin/daftar_siswa'; ?>" method="post">
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-3">
                                <label>Submit</label>
                                <input class="btn btn-block btn-success" type="submit" name="filter" value="Filter">
                            </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="importData" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                    <button type="submit" name="submit" value="upload" class="btn btn-success" id="btn-import"><i class="fa fa-file-import"></i> Import</button>
                </div>
                <?= form_close(); ?>
            </div>
        </div>
...
<script>
    $(document).ready(function(){
        $('#btn-import').on('click', function(event) {
            ...
            // Kirim form setelah mengganti ikon dan teks tombol
