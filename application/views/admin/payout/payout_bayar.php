...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success">Detail Identitas
                        <?php if($user['role_id'] == '1' && $user['role_id'] == '5') : ?>
                        <div class="float-right">
                            <a href="<?= base_url('manage/jenis_pembayaran/edit_payment_bulan/' . $row['payment_payment_id'] . '/' . $row['student_student_id']) ?>" class="btn btn-block btn-success btn-sm"><i class="fa fa-edit"></i><b>&nbsp;Edit Tarif Pembayaran</b></a>
                        </div>
                        <?php endif ?>
                    </h6>
                </div>
