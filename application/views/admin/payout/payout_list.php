        ...
        <div class="col-md-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="pt-2 fa fa-search fa-fw"></i> Cari Transaksi Pembayaran

                        <div class="float-right">
                            <a href="<?= base_url('admin/daftar_siswa') ?>" class="btn btn-block btn-success btn-sm"><i class="fa fa-users"></i> Referensi Data Siswa</a>
                        </div>
                    </h6>
				</div>
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-success"> Informasi Siswa
								...
								<div class="float-right">
								<?php if ($f['r'] != NULL) { ?>
									<a href="<?= site_url('payout/printBill' . '?n=' . $thn_msk->id .'&r=' . $f['r']) ?>" target="_blank" class="btn btn-primary btn-xs pull-right"><i class="fa fa-print"></i> Cetak Semua Tagihan</a>
								<?php } ?>
								</div>
							</h6>
						</div>
								...
								<table class="table table-striped">
									<tbody>
										<tr>
											...
											<td width="4">:</td>
											<td><strong><?= $thn_msk->period_start . '/' . $thn_msk->period_end ?><strong></td>
										</tr>
										<tr>
											<td>NIS</td>
											<td>:</td>
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form action="<?= site_url('payout/cetakBukti') ?>" method="GET" class="view-pdf">
										<input type="hidden" name="n" value="<?= $thn_msk->id ?>">
