...
class Bulan_model extends CI_Model
{
    ...
    function get($params = array())
    {
        ...
        $this->db->select('bulan.bulan_id, bulan_bill, bulan_date_pay, bulan_number_pay, bulan_pay_desc, bulan_status, bulan_input_date, bulan_last_update, url_inv, inv');
    ...
    function get_total($params = array())
    {
        ...
        $this->db->order_by('month_month_id', 'asc');
        $this->db->select('bulan.bulan_id, bulan_bill, bulan_date_pay, bulan_status, bulan_pay_desc, bulan_input_date, bulan_last_update, url_inv, inv');
    ...
    function add($data = array())
    {
        ...
        if (isset($data['kode_inv'])) {
            $this->db->set('kode_inv', $data['kode_inv']);
        }

        if (isset($data['url_inv'])) {
            $this->db->set('url_inv', $data['url_inv']);
        }

        if (isset($data['inv'])) {
            $this->db->set('inv', $data['inv']);
        }
